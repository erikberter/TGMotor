...
void AssetManager::load_resources(SDL_Renderer** ren, std::string path){
    ...
    sp_str::function_v_ss function_png = [ren, this](std::string a, std::string b){
        this->add_texture(ren, a, b.c_str());
    };
    sp_str::function_v_ss function_lst = [this](std::string a, std::string b){
